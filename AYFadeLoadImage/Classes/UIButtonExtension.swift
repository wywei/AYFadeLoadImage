...
extension UIButton {
    ...
    public func setFadeImage(with resource: Resource?,
        ...
        setFadeImage(with: resource, for: state, placeholder: nil, options: nil, progressBlock: nil, completionHandler: nil)
    }

    public func setFadeBackgroundImage(with resource: Resource?,
                                       for state: UIControl.State) {
        setFadeBackgroundImage(with: resource, for: state, placeholder: nil, options: nil, progressBlock: nil, completionHandler: nil)
    }
